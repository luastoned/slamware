...
export class AdminPresentationComponent implements OnInit {
  ...
  slides: Slide[] = [
    ...
    { id: 'group_announcement', name: 'Group Announcement', fields: [{ id: 'group_id', name: 'Group', value: '', type: 'group[]' }], fadeOut: false },
    {
      ...
      name: 'Group Scores',
      fields: [
        { id: 'group_id', name: 'Group', value: '', type: 'group[]' },
        { id: 'remove_high_low', name: 'Remove Highest/Lowest', value: false, type: 'bool' },
        { id: 'display_poets_count', name: 'Display Poets', type: 'increment', value: 0 },
      ],
      fadeOut: false,
    },
    { id: 'poet_announcement', name: 'Poet Name Announcement', fields: [{ id: 'poet_id', name: 'Poet', value: '', type: 'poet[]' }], fadeOut: false },
    {
      ...
      name: 'Poet Scores',
      fields: [
        { id: 'poet_id', name: 'Poet', value: '', type: 'poet[]' },
        { id: 'remove_high_low', name: 'Remove Highest/Lowest', value: true, type: 'bool' },
      ],
      fadeOut: false,
    },
  ];
  ...
  constructor(private dataService: DataService, private poetService: PoetService, private configService: ConfigService) {
  ...
  updatePoetScores(slide: Slide) {
    ...
    if (poet_id !== undefined) {
      ...
      if (poet !== undefined && poet.group !== undefined) {
        if (poet.scores === undefined) poet.scores = [];
      ...
      } else console.warn('no group found');
    } else {
